require(["splunkjs/mvc/utils"], function (SplunkUtil) {
    ...
    require(['jquery',
        ...
        function ($, mvc, searchManager) {
            ...
            var labelQuery = '| inputlookup illumio_labels_lookup | table value key';
            // Get list of ip_lists to populate drop-down
            var ipListsQuery = '| inputlookup illumio_ip_lists_lookup | table name href';
            // Get list of services to populate drop-down
            var servicesQuery = '| inputlookup illumio_services_lookup | table name href';
